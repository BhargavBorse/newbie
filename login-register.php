                        ...
                        <div id="lg1" class="tab-pane active">
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    <form action="sql/login-sql.php" method="post">
                                        <input type="number" name="enroll_no" placeholder="Enrollment Number" required>
                                        ...
                                        <div class="button-box">
                                            ...
                                            <button class="default-btn" name="login" type="submit"><span>Login</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    <form action="#" method="post">
                                        ...
                                        <input type="text" name="rerno" placeholder="Enrollment Number">
                                        <input type="text" name="rusername" placeholder="Name">
                                        <input name="remail" placeholder="Email" type="email">
