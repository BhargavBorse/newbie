        ...
        <header class="header-area">
                                ...
                                <div class="main-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="about-us.html"> INTERNSHIP  </a></li>
                                            <li class="mega-menu-position top-hover"><a href="shop.html"> JOBS <i class="fa fa-angle-down"></i> </a>
                                                <ul class="mega-menu">
                                                    <li>
                                                        <ul>
                                            ...
                                            <li><a href="#"> SKILL BUCKET <i class="fa fa-angle-down"></i> </a>
                                                <ul class="submenu">
                                            ...
                                            <!-- <li><a href="blog.html"> CONTACT US </a>
                                                <ul class="submenu">
            ...
            <div class="slider-area ">
                <div class="slider-active-2 owl-carousel nav-style-2">
                    <div class="single-slider slider-height-2 bg-img align-items-center d-flex slider-overlay2-1 default-overlay" style="background-image:url(assets/img/slider/slider-29.jpg);">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                                    <div class="slider-content slider-content-2 slider-animated-2 text-center">
                                        <h1 class="animated">Welcome to NewBie Hire</h1>
                                        <p class="animated">Equipping the students with relevant and conceptualized professional skills and guiding them towards a bright future and career all around the world with the values of – ‘Sincerity’, ‘Hard Work’ and ‘Ethics’.
                                            An environment providing infrastructured facilities, for newly fresher. </p>
                        ...
                        <div class="single-slider slider-height-2 bg-img align-items-center d-flex slider-overlay2-1 default-overlay" style="background-image:url(assets/img/slider/slider-29.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                                        <div class="slider-content slider-content-2 slider-animated-2 text-center">
                                            <h1 class="animated">University Events</h1>
                        ...
                        <div class="single-slider slider-height-2 bg-img align-items-center d-flex slider-overlay2-1 default-overlay" style="background-image:url(assets/img/slider/slider-29.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                                        <div class="slider-content slider-content-2 slider-animated-2 text-center">
                                            <h1 class="animated">Comming Soon</h1>
                                            <p class="animated font">
                ...
                <div class="choose-us-area pt-130 pb-130">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row"> 
                            ...
                            <div class="tab-pane active" id="course-categorie-1">
                                <div class="course-slider-active-2 nav-style-1 owl-carousel">
                                    ...
                                    <div class="course-categorie-bundle">
                                        <div class="single-course mb-30">
                                            <div class="course-img">
                                                <a href="course-details.html"><img src="assets/img/brand-logo/584830bfcef1014c0b5e4a9d.png" alt=""></a>
                                            </div>
                                            <div class="course-content course-content-2">
                                    ...
                                    <div class="course-categorie-bundle">
                                        <div class="single-course mb-30">
                                            <div class="course-img">
                                                <a href="course-details.html"><img src="assets/img/brand-logo/logo_brand_brands_logos_sketch_app-512.png" alt=""></a>
                                            </div>
                                            <div class="course-content course-content-2">
                                    ...
                                    <div class="course-categorie-bundle">
                                        <div class="single-course mb-30">
                                            <div class="course-img">
                                                <a href="course-details.html"><img src="assets/img/brand-logo/microsoft-512.png" alt=""></a>
                                                <span class="new-course">New Course</span>
                                            </div>
                                            <div class="course-content course-content-2">
                ...
                <div class="fun-fact-area bg-img pt-130 pb-100" style="background-image:url(assets/img/bg/aaa.jpg);">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div class="single-count mb-30 count-one count-white">
                                    <div class="count-img">
                                        <img src="assets/img/icon-img/achieve-4.1.png" style="color:white;" alt="">
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div class="single-count mb-30 count-two count-white">
                                    <div class="count-img">
                                        <img src="assets/img/icon-img/achieve-1.1.png" alt="">
                                    </div>
                                    <div class="count-content">
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <div class="blog-meta">
                                                    <ul>
                                                        ...
                                                        <li><a href="#"><i class="fa fa-rupee"></i> 22</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="blog-date">
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <div class="blog-meta">
                                                    <ul>
                                                        ...
                                                        <li><a href="#"><i class="fa fa-rupee"></i> 12</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="blog-date">
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <div class="blog-meta">
                                                    <ul>
                                                        ...
                                                        <li><a href="#"><i class="fa fa-rupee"></i> 20</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="blog-date">
                ...
                <!-- <div class="about-us pt-90 pb-90">
                    <div class="container">
                ...
                <div class="brand-logo-area pb-130">
                    <div class="container">
                        <div class="section-title-3 section-shape-hm2-1 text-center mb-100">
                            <h2>Connected <span>With</span></h2>
                        </div>
                        <div class="brand-logo-active owl-carousel">
                            <div class="single-brand-logo">
                                <a href="#"><img src="assets/img/brand-logo/584830bfcef1014c0b5e4a9d.png" height="100px" width="20%" alt=""></a>
                            </div>
                            <div class="single-brand-logo">
                                <a href="#"><img src="assets/img/brand-logo/github-512.png" height="100px" width="15%" alt=""></a>
                            </div>
                            <div class="single-brand-logo">
                                <a href="#"><img src="assets/img/brand-logo/google-favicon-logo-20.png" height="100px" width="15%" alt=""></a>
                            </div>
                            <div class="single-brand-logo">
                                <a href="#"><img src="assets/img/brand-logo/logo_brand_brands_logos_sketch_app-512.png" height="100px" width="15%" alt=""></a>
                            </div>
                            <div class="single-brand-logo">
                                <a href="#"><img src="assets/img/brand-logo/microsoft-512.png" height="100px" width="15%" alt=""></a>
                            </div>
                            <div class="single-brand-logo">
                                <a href="#"><img src="assets/img/brand-logo/stark-industries-logo-png-.png" height="100px" width="45%" alt=""></a>
                            </div>
                            <div class="single-brand-logo">
